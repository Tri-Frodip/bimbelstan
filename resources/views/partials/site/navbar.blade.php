<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none mb-3 navbar-transparent mt-0 pt-0" {!! $style??'' !!}>
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ url('/') }}">
            <img src="{{ asset('logo-no-bg.png') }}" style="max-width: 220px;" alt="" srcset="">
        </a>
        <button
        ...
        <div class="navbar-collapse w-100 pt-3 pb-2 py-lg-0 collapse" id="navigation">
            <ul class="navbar-nav navbar-nav-hover ms-auto">
                <li class="nav-item mx-2">
                    <a href="/" class="nav-link font-weight-bold text-dark ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuDocs">
                        Beranda
                    </a>
                </li>
                <li class="nav-item mx-2">
                    <a href="/try-out" class="nav-link font-weight-bold text-dark ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuDocs">
                        Try Out
                    </a>
                </li>
                <li class="nav-item mx-2">
                    <a href="#program-bimbel" class="nav-link font-weight-bold text-dark ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuDocs">
                        Paket Bimbel
                    </a>
                </li>
                <li class="nav-item mx-2">
                    <a href="/kontak-kami" class="nav-link font-weight-bold text-dark ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuDocs">
                        Kontak Kami
                    </a>
                </li>
